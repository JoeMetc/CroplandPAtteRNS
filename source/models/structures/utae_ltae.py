#####
# Original Source: https://github.com/VSainteuf/utae-paps/blob/main/src/backbones/ltae.py
#####
...
from models.structures.utae_positional_encoding import PositionalEncoder
